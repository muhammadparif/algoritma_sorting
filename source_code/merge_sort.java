...
public class merge_sort {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Panjang Array List: ");
        ...
        merge_sort merge_sort = new merge_sort(integerArrayList);

        System.out.print("Array Sebelum Merge Sort : ");
        for (Integer integer : merge_sort.getArrayAfterSorting()) {
            System.out.print(integer+" ");
        }

        System.out.println();

        merge_sort.divideArrayElements(0, integerArrayList.size() - 1);

        System.out.print("Array Sesudah di Merge Sort : ");
        merge_sort.getArrayAfterSorting().forEach((integer) -> {
            System.out.print(integer+" ");
        });
        System.out.println();
